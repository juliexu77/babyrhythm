...
const translations = {
  en: {
    ...
    logFeedNow: "Log this Feed",
    logNapNow: "Log This Nap",
    startNap: "Start Nap",
    ...
    feedingScheduleLooksGreat: "Feeding schedule looks great",
    excellentNapRoutine: "Excellent nap routine with",
    startLoggingForInsights: "Start logging activities to see personalized insights",
    greatSleep: "Great sleep!",
    noNapsYet: "No naps yet",
    activityDetails: "Activity Details",
    pleaseLogInToUpload: "Please log in to upload photos.",
    authenticationRequired: "Authentication required",
    alreadyHaveAccount: "Already have an account? Log in",
    noHouseholdFound: "No household found",
    letsSetupHousehold: "Let's set up your household to get started.",
    ...
    // HomeTab greetings and messages
    goodMorning: "Good morning",
    goodAfternoon: "Good afternoon",
    goodEvening: "Good evening",
    inSleepyNewbornPhase: "in the sleepy newborn phase",
    discoveringWorld: "discovering the world around them",
    curiousExploratoryPhase: "in the curious, exploratory phase",
    becomingMobile: "becoming more mobile and independent",
    learningToCommunicate: "learning to communicate and express",
    growingIntoOwnPerson: "growing into their own little person",
    youreDoingGreat: "You're doing great",
    smallRhythmsAddingUp: "These small rhythms are adding up.",
    growthSpurtWeek: "Growth spurt week",
    comfortDay: "Comfort day",
    freshStart: "Fresh start",
    peacefulDay: "Peaceful day",
    onTarget: "On target",
    smoothFlow: "Smooth flow",
    mixedPatterns: "Mixed patterns",
    adjustmentPhase: "Adjustment phase",
    activeRhythm: "Active rhythm",
    goingWithFlow: "Flexible rhythm",
    settledRhythmDay: "Settled rhythm day",
    findingBalance: "Finding balance",
    gentlePace: "Light day",
    learningTogether: "Morning start",
    buildingRhythm: "Building rhythm",
    strongRestorativeNap: "a strong, restorative nap",
    restingDeeply: "resting deeply",
    settlingIn: "settling in",
    hasBeenSleepingSince: "has been sleeping since",
    hasBeenRestingFor: "has been resting for",
    startingNewDay: "Starting a new day with",
    yesterdayRhythm: "Yesterday's rhythm shows below — ready to log today's first moment?",
    hasBeenAwakeFor: "has been awake for",
    readyToStartDay: "is ready to start the day",
    sleepingSince: "Sleeping since",
    baby: "Baby",
    tapGreenToLog: "Tap the green + below to log your first event",
    feedsLabel: "Feeds:",
    sleepLabel: "Sleep:",
    overallLabel: "Overall:",
    calmAndSteady: "Calm and steady",
    logged: "logged",
    napCompleted: "nap completed",
    napsCompleted: "naps completed",
    feedsConsistent: "Steady rhythm builds confidence",
    rightOnRhythm: "Right on track for {months}mo",
    gettingStartedToday: "First entries of the day",
    lightFeedingDay: "Lighter than usual for {months}mo",
    extraFeedsToday: "Growth spurt or comfort feeding",
    everyNapProgress: "Every nap is progress",
    solidNapRhythm: "{baby} self-regulating well",
    workingOnFirstNap: "Day just getting started",
    shorterNapDay: "Shorter naps, still normal",
    extraRestfulDay: "Catching up on sleep",
    earlyInDay: "Day just beginning",
    moreRestComing: "More sleep likely ahead",
    extraRestToday: "Above average rest"
  },
  zh: {
    // App name and core  
    appName: "宝宝追踪器",
    ...
    observations: "观察",
    todaysInsights: "今日洞察",
    feedingScheduleLooksGreat: "喂养计划看起来很好",
    excellentNapRoutine: "出色的小睡常规",
    startLoggingForInsights: "开始记录活动以查看个性化洞察",
    greatSleep: "睡得很好！",
    noNapsYet: "尚未小睡",
    activityDetails: "活动详情",
    pleaseLogInToUpload: "请登录以上传照片。",
    authenticationRequired: "需要认证",
    alreadyHaveAccount: "已有账户？登录",
    noHouseholdFound: "未找到家庭",
    letsSetupHousehold: "让我们设置您的家庭以开始使用。",
    goToOnboarding: "前往新手引导",
    ...
    goodAfternoon: "下午好",
    goodEvening: "晚上好",
    inSleepyNewbornPhase: "处于困倦的新生儿阶段",
    discoveringWorld: "正在探索周围的世界",
    curiousExploratoryPhase: "处于好奇的探索阶段",
    becomingMobile: "变得更加活跃和独立",
    learningToCommunicate: "正在学习沟通和表达",
    growingIntoOwnPerson: "成长为自己的小人儿",
    youreDoingGreat: "你做得很棒",
    smallRhythmsAddingUp: "这些小小的节奏正在累积。",
    growthSpurtWeek: "成长突增周",
    comfortDay: "安慰日",
    freshStart: "全新开始",
    peacefulDay: "平静的一天",
    onTarget: "达标",
    smoothFlow: "顺畅进行",
    mixedPatterns: "混合模式",
    adjustmentPhase: "调整阶段",
    activeRhythm: "活跃节奏",
    goingWithFlow: "灵活节奏",
    settledRhythmDay: "稳定节奏日",
    findingBalance: "寻找平衡",
    gentlePace: "轻松日",
    learningTogether: "早晨开始",
    buildingRhythm: "建立节奏",
    strongRestorativeNap: "深度恢复性午睡",
    restingDeeply: "深度休息中",
    settlingIn: "入睡中",
    hasBeenSleepingSince: "已经在睡觉，从",
    hasBeenRestingFor: "已经休息了",
    startingNewDay: "与...开始新的一天",
    yesterdayRhythm: "昨天的节奏显示在下方 — 准备好记录今天的第一刻了吗？",
    hasBeenAwakeFor: "已经醒着",
    readyToStartDay: "准备开始新的一天",
    sleepingSince: "自...以来睡觉",
    baby: "宝宝",
    tapGreenToLog: "点击下方的绿色 + 记录您的第一个事件",
    feedsLabel: "喂养：",
    sleepLabel: "睡眠：",
    overallLabel: "总体：",
    calmAndSteady: "平静而稳定",
    logged: "已记录",
    napCompleted: "次午睡已完成",
    napsCompleted: "次午睡已完成",
    feedsConsistent: "稳定节奏建立信心",
    rightOnRhythm: "{months}月龄正常节奏",
    gettingStartedToday: "今日首次记录",
    lightFeedingDay: "{months}月龄较轻量",
    extraFeedsToday: "生长突增或安抚性喂养",
    everyNapProgress: "每次午睡都是进步",
    solidNapRhythm: "{baby}自我调节良好",
    workingOnFirstNap: "一天刚刚开始",
    shorterNapDay: "午睡较短，仍正常",
    extraRestfulDay: "补充睡眠中",
    earlyInDay: "一天刚开始",
    moreRestComing: "可能还会睡更多",
    extraRestToday: "休息高于平均"
  }
};
