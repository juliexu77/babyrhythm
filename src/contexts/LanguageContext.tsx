...
const translations = {
  en: {
    ...
    feedsConsistent: "Feeds consistent — steady rhythm",
    rightOnRhythm: "On rhythm for {months}mo",
    gettingStartedToday: "Just starting today",
    lightFeedingDay: "Light day for {months}mo",
    extraFeedsToday: "Extra feeds — growth or comfort",
    everyNapProgress: "Building sleep habits",
    solidNapRhythm: "Solid rhythm — {baby} regulating well",
    workingOnFirstNap: "Working on first nap",
    shorterNapDay: "Short nap day — normal",
    extraRestfulDay: "Extra restful day",
    earlyInDay: "Early in the day",
    moreRestComing: "More rest coming",
    extraRestToday: "Extra rest today"
  },
  zh: {
    // App name and core  
    appName: "宝宝追踪器",
    ...
    feedsConsistent: "喂养稳定",
    rightOnRhythm: "{months}月节奏恰当",
    gettingStartedToday: "刚开始今天",
    lightFeedingDay: "{months}月轻度喂养",
    extraFeedsToday: "额外喂养 — 生长或安慰",
    everyNapProgress: "建立睡眠习惯",
    solidNapRhythm: "节奏扎实 — {baby}调节良好",
    workingOnFirstNap: "第一次午睡",
    shorterNapDay: "短午睡 — 正常",
    extraRestfulDay: "额外休息日",
    earlyInDay: "一天的早期",
    moreRestComing: "更多休息即将到来",
    extraRestToday: "今天额外休息"
  }
};
