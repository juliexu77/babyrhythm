...
import { Calendar, User, Undo2, Share, X, Bell, Settings } from "lucide-react";
    ...
    case "history":
        return (
          <HistoryTab
            ...
            onToggleTravelDay={toggleTravelDay}
            isTravelDay={isTravelDay}
            onShowPediatricianReport={() => setShowPediatricianReport(true)}
            onShowCSVExport={() => setShowCSVExport(true)}
