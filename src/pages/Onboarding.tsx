      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="max-w-md mx-auto text-center space-y-10">
          ...
          <div className="space-y-8">
            <h1 className="text-[22px] md:text-[36px] font-medium tracking-tight" style={{ lineHeight: '1.25', color: 'rgba(200, 200, 200, 0.95)' }}>
              Where intuition meets intelligence
            </h1>
            <p className="text-[15px] md:text-[16px] leading-[1.6] font-normal mt-8" style={{ color: 'rgba(180, 180, 180, 0.90)' }}>
            ...
            <p className="text-[15px] md:text-[16px] leading-[1.6] font-normal" style={{ color: 'rgba(180, 180, 180, 0.90)' }}>
