...
export const CollectivePulse = ({ babyBirthday }: CollectivePulseProps) => {
  ...
  if (isLoading) {
    return (
      <div className="mx-2 mb-6 rounded-xl bg-[hsl(var(--card-ombre-4))] shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-border/20 overflow-hidden animate-pulse">
  ...
  if (!cohortStats) {
    return (
      <div className="mx-2 mb-6 rounded-xl bg-[hsl(var(--card-ombre-4))] shadow-[0_2px_8px_rgba(0,0,0,0.04)] border border-border/20 overflow-hidden">
        <div className="px-4 py-5 border-b border-border/30">
