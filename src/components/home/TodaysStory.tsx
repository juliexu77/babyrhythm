...
export function TodaysStory({ onClick }: TodaysStoryProps) {
  return (
    <button 
      onClick={onClick}
      className="group inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[hsl(320_40%_92%)] dark:bg-[hsl(320_40%_25%)] hover:bg-[hsl(320_40%_88%)] dark:hover:bg-[hsl(320_40%_30%)] transition-all duration-300 animate-story-breathe"
    >
