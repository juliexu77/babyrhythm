...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 dark:rounded-sharp dark:transition-all dark:duration-200",
  {
    variants: {
      variant: {
        ...
        cta: "bg-gradient-to-r from-[hsl(var(--cta-gradient-start))] to-[hsl(var(--cta-gradient-end))] text-white font-semibold hover:brightness-90 animate-cta-pulse",
      },
      size: {
