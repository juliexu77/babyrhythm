...
export const MissedActivityPrompt = ({ 
  ...
  return (
    <div className="mt-4 p-4 bg-purple-50/80 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg animate-in fade-in slide-in-from-bottom-2 duration-300">
