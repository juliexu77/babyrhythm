-- Backfill mis-stored activity timestamps from last 2 days
...
BEGIN
  -- Process activities created in last 48 hours where timezone is America/Los_Angeles
  ...
  LOOP
    -- Determine if we're in PDT (-7) or PST (-8)
  ...
  RAISE NOTICE 'Backfill complete. Fixed % activities from last 48 hours.', fixed_count;
END $$;